...
describe("DecoratorUtils", function () {
  describe("getDeclarationType()", function () {
    it("should correctly detect class declarations", function () {
      function decorator() {
        (_.DecoratorUtils.getDeclarationType(arguments) === _.DecoratorUtils.declarationType.CLASS).should.be["true"]();
      };
    ...
    it("should correctly detect class methods", function () {
      function decorator() {
        (_.DecoratorUtils.getDeclarationType(arguments) === _.DecoratorUtils.declarationType.CLASS_METHOD).should.be["true"]();
      };
    ...
    it("should correctly detect class accessors", function () {
      function decorator() {
        (_.DecoratorUtils.getDeclarationType(arguments) === _.DecoratorUtils.declarationType.CLASS_ACCESSOR).should.be["true"]();
      };
    ...
    it("should correctly detect object literal methods", function () {
      function decorator() {
        (_.DecoratorUtils.getDeclarationType(arguments) === _.DecoratorUtils.declarationType.OBJECT_LITERAL_METHOD).should.be["true"]();
      };
    ...
    it("should correctly detect object literal accessors", function () {
      function decorator() {
        (_.DecoratorUtils.getDeclarationType(arguments) === _.DecoratorUtils.declarationType.OBJECT_LITERAL_ACCESSOR).should.be["true"]();
      };
